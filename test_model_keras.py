...
# Load the dataset
captions_mapping, text_data = load_captions_data("D:\DIT\First Sem\Computer Vision\EchoLens\Fliker_30K\captions.txt")
...
caption_model = keras.models.load_model(r"D:\DIT\First Sem\Computer Vision\EchoLens-Pretrained-Windows\src\caption_model_flicker_30k_18epocs.keras")




with open(r"D:\DIT\First Sem\Computer Vision\EchoLens-Pretrained-Windows\src\vectorization_layer_state_30k_18epocs.pkl", "rb") as f:
    vectorization_loaded_data = pickle.load(f)
config, vocab = vectorization_loaded_data['config'], vectorization_loaded_data['vocab']
print("vocab", len(vocab))
...
#         # Text settings
#         decoded_caption = generate_caption(os.path.join(folder_path, i))
#         text = decoded_caption.upper()
#         org = (2, 940)  # position (x, y)
...
#         i = "captioned_" + i
#         cv2.imwrite(os.path.join(folder_path, i), img)
#         #cv2.waitKey(0)
