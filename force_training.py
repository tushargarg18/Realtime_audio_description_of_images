...
if __name__ == "__main__":
    ...
    # filepath: /mnt/d/DIT/First Sem/Computer Vision/EchoLens/src/training.py
    single_batch = next(iter(dataloader))


    # filepath: /mnt/d/DIT/First Sem/Computer Vision/EchoLens/src/training.py
for epoch in range(100):  # Use a large number of epochs
    encoder.train()
    decoder.train()
    imgs, imgs_name, captions = single_batch
    print("Image Name:", imgs_name)
    imgs = imgs.to(device)
